...
public class TaskManagementService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/TaskManagementService/services/TaskManagementService?wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/TaskManagementService/services/TaskManagementService?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
