...
public abstract class UserManagementServicePortTypeBase implements UserManagementServicePortType, AuthenticationServiceFilter {

	private static final Logger LOG = Logger.getLogger(UserManagementServicePortTypeBase.class.getName());
	...
	public org.tsk.mng.taskmanagement.common_elements.user.userresult.UserResult readUserOperation(org.tsk.mng.taskmanagement.header.soapheader.UserAuthInfo soapHeader,org.tsk.mng.taskmanagement.usermanagementwrapper.ReadUserTypeRequest readUserRequest) { 
		...
		try {
			...
			if (authResult.getResultStatus() == OperationResultStatus.SUCCESS) {
				...
				return readUserTemplate(readUserRequest);
	...
	protected abstract UserResult readUserTemplate(ReadUserTypeRequest readUserRequest);
