...
public class UserManagementService extends Service {
    ...
    static {
        ...
        try {
            ...
            System.err.println("Can not initialize the default wsdl from http://localhost:8080/tsk-mng-frontend-0.0.1-REVISION/services/UserManagementServicePort?wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
